...
> 特定技能・育成就労制度の登録支援機関データベース。出入国在留管理庁の登録支援機関登録簿（一次情報）に基づき全国11,000件超の機関を掲載し、対応言語・地域・特定技能分野・行政処分歴で検索できます。運営が本人確認した機関には「掲載情報 運営確認済み」と確認日を表示しています。相談・掲載情報の確認修正はすべて無料です。
