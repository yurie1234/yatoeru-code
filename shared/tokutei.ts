...
export const AFFINITY_WEIGHTS = {
  ...
  language: 20, // 希望言語対応
  // 受入状況：新規相談を受け付けていることが本人確認済みの機関を加点する。
  // 相談しても受け付けていない機関を上位に出すと利用者にとって無価値なため、
  // 「今この機関に相談できるか」を条件適合と並ぶ評価軸として扱う。
  // 未確認・一時停止は0点（減点はしない）。ステータスの登録は無料で全機関に
  // 開かれており、有料掲載とは連動しない。
  consultOpenActive: 10, // 受入状況：受付中（積極受入）
  consultOpen: 7, // 受入状況：受付中
