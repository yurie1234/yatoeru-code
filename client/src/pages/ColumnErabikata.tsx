      ...
      <div className="bg-brand text-brand-foreground py-12">
        <div className="container">
          ...
          <p className="text-brand-foreground/80 max-w-3xl leading-relaxed">
            委託先選びで最初に知りたいのは料金の相場のはずです。結論から言うと
            <strong>
              1人あたり月額1.5万〜4万円程度、出入国在留管理庁の調査では平均約28,000円・約9割が3万円以下
            </strong>
            です。ただ、相場を知っただけでは選べません。平均の周りには倍以上の幅があり、その差が何の差なのか——支援範囲なのか、体制なのか、ただの言い値なのか——を見分ける目が要るからです。見分けに使える確認項目は7つに整理でき、どれも登録簿と見積書だけで確かめられます。
          </p>
      ...
      <div id="article-main" className="container py-10 max-w-4xl space-y-10">
        ...
        <section id="zentei" className="scroll-mt-20">
          ...
          <div className="space-y-4 text-base leading-[1.9] text-foreground/90">
            ...
            <p>
              2026年7月9日時点で全国に11,448件。この数を見て「どうやって選べばいいのか」と途方に暮れるのは自然な反応です。しかも登録されていることと、良い支援をしてくれることは別です。登録はあくまで入口の要件を満たした証であって、料金・体制・得意分野は機関ごとに大きく異なります。
            </p>
          </div>
        </section>
        ...
        <section id="kakunin" className="scroll-mt-20">
          ...
          <div className="space-y-4 text-base leading-[1.9] text-foreground/90">
            <p>
              ...
              委託候補の機関に登録番号（「19登-XXXXXX」等の形式）と登録年月日を尋ねます。適法に営んでいる機関なら即答できる質問です。ここで言いよどむなら、その時点で候補から外して構いません。
            </p>
            <p>
