      ...
      <div className="bg-brand text-brand-foreground py-12">
        <div className="container">
          ...
          <p className="text-brand-foreground/80 max-w-3xl leading-relaxed">
            <strong>
              「外国人採用はコストが高そう」というイメージは、比較対象を並べると変わります。国内在住の特定技能人材の採用は初年度1人あたり約34〜78万円が目安で、人材紹介経由の中途採用（約90〜120万円）を下回るケースが多くあります。
            </strong>
            本記事では採用手法別の1人あたり年間総コストを、一次情報に基づいて横並びで比較します。
          </p>
      ...
      <div className="container py-10 max-w-4xl space-y-10">
        ...
        <section id="tokutei" className="scroll-mt-20">
          ...
          <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
            <p>
              特定技能のコストは<strong className="text-foreground">「初期費用」と「毎月の支援委託費」の2階建て</strong>です。
              初期費用には在留資格申請の取次報酬（行政書士・登録支援機関、約10〜20万円）、健康診断・事前ガイダンス費用などが含まれます。
              海外から呼び寄せる場合は、送出機関への手数料や渡航費が加わり約30〜60万円まで上がります。
            </p>
            <p>
              毎月の支援委託費は、出入国在留管理庁の調査で<strong className="text-foreground">1人あたり平均約2.8万円/月</strong>です。
              義務的支援のみか生活支援まで含むかで月1.5万円台〜4万円超まで幅があるため、複数機関からの見積もり比較が最も効果的なコスト削減策になります。
            </p>
            <p>
              詳しい内訳は
        ...
        <section id="ikusei" className="scroll-mt-20">
          ...
          <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
            <p>
              育成就労（技能実習から移行する新制度）は、監理支援機関への加入・監理費、送出機関費用、入国後講習費などで
              <strong className="text-foreground">初期費用約50〜145万円、監理費月2.5〜5万円/人</strong>が目安です。
              特定技能より高くなりますが、未経験人材を3年かけて育成し特定技能1号へ接続する長期定着前提の投資という位置づけです。
            </p>
            <p>
              制度の詳細は
        ...
        <section id="kokunai" className="scroll-mt-20">
          ...
          <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
            <p>
              人材紹介は<strong className="text-foreground">理論年収の30〜35%</strong>が成功報酬の相場で、年収330万円の人材なら約100万円です。
              即戦力を1名だけ確保したい場合には合理的ですが、介護・外食・建設など人手不足が深刻な職種では、そもそも候補者が集まらず採用に至らないことが課題になります。
            </p>
            <p>
        ...
        <section id="joseikin" className="scroll-mt-20">
          ...
          <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
            <p>
              外国人労働者の就労環境整備に取り組む企業は、
              <strong className="text-foreground">人材確保等支援助成金（外国人労働者就労環境整備助成コース）で経費の1/2〜2/3・最大72万円</strong>
              の支給対象になり得ます。このほか賃上げを伴う設備投資には業務改善助成金（最大600万円）、非正規から正規への転換にはキャリアアップ助成金（1人最大80万円）など、外国人にも適用される制度があります。
            </p>
            <p>
              各制度の要件・対象になるケースは
              <Link href="/joseikin">
