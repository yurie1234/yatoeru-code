                          ...
                          {sort === "affinity" && hasAffinityCondition && org.affinity && (
                            <Tooltip>
                              ...
                              <TooltipContent side="bottom" className="max-w-xs text-xs">
                                ...
                                <p className="mt-1.5 opacity-70">配点：分野40／地域30／言語20／受入状況10（積極受入10・受付中7）／信頼性10（処分歴なし5＋実確認鮮度最大5）。指定していない条件は配点に含めないため、満点は条件により変わります。</p>
                                <p className="mt-1 opacity-70">運営による実確認済みの情報には、情報の確からしさとして最大5点を加点しています（確認日から時間経過で減衰）。有料掲載の有無・当サイトへの紹介料の有無はスコアに影響しません。</p>
                              </TooltipContent>
                            </Tooltip>
                          )}
