      ...
      <div className="bg-brand text-brand-foreground py-12">
        <div className="container">
          ...
          <p className="text-brand-foreground/80 max-w-3xl leading-relaxed">
            <strong>
              人材紹介会社（厚生労働省の有料職業紹介許可）と登録支援機関（出入国在留管理庁の登録）は別制度・別登録であり、「紹介はできるが支援はできない」会社に支援まで任せたつもりになると、支援体制基準を満たせず特定技能外国人を受け入れられないおそれがあります。
            </strong>
            委託前に登録番号（「19登-XXXXXX」等）を確認し、入管庁の登録簿と照合することがもっとも確実な自衛策です。
          </p>
      ...
      <div className="container py-10 max-w-4xl space-y-10">
        ...
        <section id="kondou" className="scroll-mt-20">
          ...
          <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
            <p>
              特定技能人材の採用現場では、「外国人材を紹介します。入社後のサポートもお任せください」という営業を受けることが少なくありません。人材の紹介と入社後の支援は連続したサービスに見えるため、多くの担当者が同じ資格でできる業務だと考えがちです。
            </p>
            <p>
              しかし実際には、人材の紹介は<strong className="text-foreground">職業安定法に基づく有料職業紹介事業の許可（厚生労働省）</strong>、特定技能1号外国人への支援は<strong className="text-foreground">入管法に基づく登録支援機関の登録（出入国在留管理庁）</strong>という、所管も根拠法も異なる2つの制度に分かれています。両方を適法に行うには両方の許可・登録が必要で、片方しか持たない事業者は珍しくありません。
            </p>
          </div>
        </section>
        ...
        <section id="tejun" className="scroll-mt-20">
          ...
          <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
            <p>
              ...
              「登録支援機関の登録番号を教えてください」と一言確認します。適法に支援業務を行っている機関であれば即答できます。「申請中」「グループ会社が持っている」という回答の場合は、実際に支援を行う主体がどこかを契約書で確認してください（支援業務の再委託は認められていません）。
            </p>
            <p>
