...
const STATIC_HEADS: Record<string, { title: string; description: string }> = {
  ...
  "/ikusei-shuro": {
    ...
    description:
      "「いまの監理団体は育成就労でも使える？」→自動的には使えません。2027年4月1日施行の育成就労制度について、監理支援機関への移行状況トラッカー（全国3,733団体）・施行スケジュール・受入企業の準備チェックリストをまとめています。",
  },
  "/ikusei-shuro/kanri-shien-kikan/list": {
    title:
      "監理支援機関の一覧はまだない？監理団体の移行状況トラッカー【全国3,733団体・毎月更新】 - ヤトエル",
    description:
      "監理支援機関の許可済み一覧は許可証交付が2027年4月以降のため公的にはまだ存在しません。当サイトはOTIT許可一覧の監理団体全国3,733団体について、育成就労への移行状況を独自調査し毎月更新で公開しています。都道府県・許可区分・移行ステータスで検索できます。",
  },
  "/ikusei-shuro/schedule": {
    title:
      "育成就労はいつから？施行スケジュール完全ガイド【2026年9月に計画認定申請開始】 - ヤトエル",
    description:
      "育成就労制度は2027年4月1日施行（政令確定）。監理支援機関の許可申請は2026年4月15日受付開始済み、育成就労計画の認定申請は2026年9月1日開始。在籍企業・初受入企業それぞれの準備タイムラインを時系列で解説します。",
  },
  "/ikusei-shuro/checklist": {
    title:
      "【保存版】育成就労への切り替えチェックリスト10項目｜監理支援機関の選び方 - ヤトエル",
    description:
      "技能実習から育成就労への切り替え準備を10項目に整理。現在の監理団体の移行確認（今すぐ）、制度対応（〜2026年9月）、委託先の切り替え判断（〜2027年3月）の3ブロックで、上から順に進められます。",
  },
  ...
  "/area/aichi": {
    ...
    description:
      "愛知県の特定技能・育成就労受入ガイド。登録支援機関1,121社・監理団体400団体を掲載。自動車産業を中心とした主要受入分野、県の外国人材支援制度、監理支援機関への移行状況をまとめています。",
  },
  "/area/osaka": {
    title:
      "大阪府の登録支援機関・監理団体ガイド【特定技能在留者数 全国2位】 - ヤトエル",
    description:
      "大阪府の特定技能・育成就労受入ガイド。登録支援機関1,014社・監理団体297団体を掲載。外食業・製造業を中心とした主要受入分野、府の外国人材支援制度、監理支援機関への移行状況をまとめています。",
  },
  "/area/tokyo": {
    title:
      "東京都の登録支援機関・監理団体ガイド【特定技能在留者数 全国3位】 - ヤトエル",
    description:
      "東京都の特定技能・育成就労受入ガイド。登録支援機関2,326社（全国最多）・監理団体374団体を掲載。外食・ビルクリーニング・介護など主要受入分野と都の支援制度をまとめています。",
  },
  "/area/saitama": {
    title:
      "埼玉県の登録支援機関・監理団体ガイド【特定技能在留者数 全国4位】 - ヤトエル",
    description:
      "埼玉県の特定技能・育成就労受入ガイド。登録支援機関466社・監理団体137団体を掲載。食品製造・金属加工・物流を中心とした主要受入分野と県の支援制度をまとめています。",
  },
  "/area/chiba": {
    title:
      "千葉県の登録支援機関・監理団体ガイド【特定技能在留者数 全国5位】 - ヤトエル",
    description:
      "千葉県の特定技能・育成就労受入ガイド。登録支援機関518社・監理団体173団体を掲載。農業・食品加工・航空など県の特徴的な受入分野と支援制度をまとめています。",
  },
  "/area/kanagawa": {
    title:
      "神奈川県の登録支援機関・監理団体ガイド【特定技能在留者数 全国6位】 - ヤトエル",
    description:
      "神奈川県の特定技能・育成就労受入ガイド。登録支援機関432社・監理団体94団体を掲載。京浜工業地帯の製造業・造船を中心とした受入分野と県の支援制度をまとめています。",
  },
  "/area/fukuoka": {
    title:
      "福岡県の登録支援機関・監理団体ガイド【特定技能在留者数 全国7位】 - ヤトエル",
    description:
      "福岡県の特定技能・育成就労受入ガイド。登録支援機関555社（九州最多）・監理団体181団体を掲載。外食・農業・製造業を中心とした受入分野と県の支援制度をまとめています。",
  },
  "/area/hokkaido": {
    title:
      "北海道の登録支援機関・監理団体ガイド【特定技能在留者数 全国8位】 - ヤトエル",
    description:
      "北海道の特定技能・育成就労受入ガイド。登録支援機関280社・監理団体101団体を掲載。農業・漁業・水産加工など一次産業系の受入分野と道の支援制度をまとめています。",
  },
  "/area/hiroshima": {
    title:
      "広島県の登録支援機関・監理団体ガイド【特定技能在留者数 全国9位】 - ヤトエル",
    description:
      "広島県の特定技能・育成就労受入ガイド。登録支援機関340社・監理団体163団体を掲載。自動車・造船を中心とした主要受入分野と県の支援制度をまとめています。",
  },
  "/area/shizuoka": {
    title:
      "静岡県の登録支援機関・監理団体ガイド【特定技能在留者数 全国10位】 - ヤトエル",
    description:
      "静岡県の特定技能・育成就労受入ガイド。登録支援機関342社・監理団体154団体を掲載。輸送用機器・食品製造を中心とした受入分野と県の支援制度をまとめています。",
  },
  "/guide/ikusei-shuro": {
    title:
...
export async function prefetchForPath(
  ...
  if (staticHead) {
    ...
    // 分野特化・都道府県ページ：パンくず（FAQは各ページ本文内で表示）
    if (!article && !guideFaqs && (clean.startsWith("/bunya/") || clean.startsWith("/area/"))) {
      jsonLd.push(
        breadcrumbLd([
          { name: "ホーム", path: "/" },
          {
            name: clean.startsWith("/bunya/") ? "分野別ガイド" : "地域ガイド",
            path: clean.startsWith("/bunya/") ? "/search" : "/stats",
          },
          { name: staticHead.title.replace(/ - ヤトエル$/, ""), path: clean },
        ])
      );
